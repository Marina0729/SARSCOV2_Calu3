...
sample1 <- read.csv("data/sample1_CDS.csv", skip =1) %>% 
  filter(Chr == "chrM") %>% 
  mutate(sample = "s1")
...
all_samples_chrM <- bind_cols(sample1$Geneid,
                              sample1_select$s1,sample1_select$s1,sample1_select$s1,sample2_select$s2,sample3_select$s3,sample4_select$s4,
                              sample5_select$s5,sample6_select$s6,sample7_select$s7,sample8_select$s8,sample9_select$s9)
